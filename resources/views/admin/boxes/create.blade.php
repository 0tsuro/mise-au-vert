        ...
        <div class="max-w-4xl mx-auto px-6 lg:px-10 pt-10">
            <div class="mb-10">
                ...
                <p class="text-bark max-w-2xl">
                    Ajoutez un nouveau box à votre pension et associez-lui un type de gardiennage.
                </p>
            </div>
                    ...
                    <div>
                        ...
                        >
                            ...
                            @foreach($types as $type)
                                <option value="{{ $type->id }}" @selected(old('type_gardiennage_id') == $type->id)>
                                    {{ $type->libelle }}
                                </option>
                            @endforeach
                        </select>
